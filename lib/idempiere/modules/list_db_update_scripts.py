...
options:
    idempiere_path:
        description: Idempiere installation path. Defaults to '/home/idempiere/idempiere_server'.
        required: false
        type: str
...
def run_module():
    ...
    module_args = dict(
        idempiere_path=dict(type='str', required=False, default='/home/idempiere/idempiere_server'),
    ...
    sqlsList = idempiere.getNotExecutedSqlsList()
